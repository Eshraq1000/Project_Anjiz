...
UI()
    ...
    func UI() {
        ...
        labelLog.textColor = #colorLiteral(red: 0.2687272429, green: 0.3382961154, blue: 0.2888988853, alpha: 1)
        ...
        buttonLog.frame = CGRect(x: 90, y: 570, width: 230, height: 50)
        buttonLog.layer.cornerRadius = 25
        buttonLog.backgroundColor = #colorLiteral(red: 0.2687272429, green: 0.3382961154, blue: 0.2888988853, alpha: 1)
